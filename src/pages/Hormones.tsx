  ...
  const hormonesArticles = [
    {
      ...
      description: "Как нормализовать гормональный фон женщины после 30. Признаки дисбаланса, причины нарушений, эффективные способы восстановления",
      tags: ["баланс", "30+", "здоровье", "гормоны"],
      author: "Др. Мария Сидорова",
      date: "11 августа 2025",
      readTime: "13 мин",
      image: "/img/51d68b72-76a7-447d-981b-afd26e2d9bd4.jpg",
      link: "/hormones/gormonalny-balans-zhenshchin-posle-30"
    },
    {
      id: 7,
